...
class Chick(pygame.sprite.Sprite):
    ...
    def __init__(self, screen, init_x, init_y, init_x_speed, init_y_speed, mute):
        ...
        self.screen = screen
        self.image_1 = self.load_image("Chick1.jpg")
        self.image_2 = self.load_image("Chick2.jpg")
...
class Chicken(pygame.sprite.Sprite):
    ...
    def __init__(self, screen, init_x, init_y, init_x_speed, init_y_speed, mute):
        ...
        pygame.sprite.Sprite.__init__(self)
        self.screen = screen
        self.image_1 = self.load_image("Chicken1.jpg")
        self.image_2 = self.load_image("Chicken2.jpg")
        self.image = self.image_1
        self.x = init_x
        self.y = init_y
        self.dx = init_x_speed
...
class Cow(pygame.sprite.Sprite):
    ...
    def __init__(self, screen, init_x, init_y, init_x_speed, init_y_speed, mute):
        ...
        pygame.sprite.Sprite.__init__(self)
        self.screen = screen
        self.image_1 = self.load_image("Cow1.jpg")
        self.image_2 = self.load_image("Cow2.png")
        self.image = self.image_1
        self.x = init_x
        self.y = init_y
        self.dx = init_x_speed
